...
const Social = () => {
  return (
    <div className="home__social">
      <a href="https://leetcode.com/u/agraharikalash/" className="home__social-icon" target='_blank'>
      <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" viewBox="0 0 24 24" id="leetcode">
      <defs>
        ...
        <a href="https://www.geeksforgeeks.org/user/agraharik9696/" className="home__social-icon" target='_blank'>
      <svg xmlns="http://www.w3.org/2000/svg" width = "20" viewBox="0 0 48 48" id="gfg">
      <defs>
                    <linearGradient id="redOrangeGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style={{stopColor:"red",stopOpacity:"1"}} />
                        <stop offset="100%" style={{stopColor:"orange",stopOpacity:"1"}} />
